...
eviction_county_2010$region[eviction_county_2010$name == "District of Columbia"] <- "Northeast"
# load color palette
...
plot_time_rural <- function(df, vlist, hl) {
  ...
  labs(title = paste(hl, "Filing Counties Over Time"),
       caption = "Data from evictionlab.org") + 
  scale_color_manual(values=c(color_pal[9], color_pal[11])) +
  theme_bw()
}
...
tplot_region <- grid.arrange(tplot_south, tplot_northeast, tplot_north_cent, tplot_west)
ggsave("./fig/tplot_region.png")
bplot_region <- grid.arrange(bplot_south, bplot_northeast, bplot_north_cent, bplot_west)
ggsave("./fig/bplot_region.png")
```
...
tplot_reg_rural <- grid.arrange(tplot_south_rural, tplot_northeast_rural, tplot_north_cent_rural, tplot_west_rural)
ggsave("./fig/tplot_reg_rural.png")
bplot_reg_rural <- grid.arrange(bplot_south_rural, bplot_northeast_rural, bplot_north_cent_rural, bplot_west_rural)
ggsave("./fig/bplot_reg_rural.png")
```
...
bot_pov <- dense_plot_demos(ecplot, bot_lists, "poverty_rate", color_pal[1], "Poverty Rate", "Lowest")
pov_dist <- grid.arrange(top_pov,bot_pov)
ggsave("./fig/pov_dist.png")
top_rb <- dense_plot_demos(ecplot, top_lists, "rent_burden", color_pal[2], "Rent Burden", "Highest")
bot_rb <- dense_plot_demos(ecplot, bot_lists, "rent_burden", color_pal[2], "Rent Burden", "Lowest")
rb_dist <- grid.arrange(top_rb,bot_rb)
ggsave("./fig/rb_dist.png")
top_pct_wh <- dense_plot_demos(ecplot, top_lists, "pct_white", color_pal[3], "% White", "Highest")
bot_pct_wh <- dense_plot_demos(ecplot, bot_lists, "pct_white", color_pal[3], "% White", "Lowest")
pct_wh_dist <- grid.arrange(top_pct_wh,bot_pct_wh)
ggsave("./fig/pct_wh_dist.png")
top_pct_n_wh <- dense_plot_demos(ecplot, top_lists, "pct_nonwhite", color_pal[4], "% Nonwhite", "Highest")
bot_pct_n_wh <- dense_plot_demos(ecplot, bot_lists, "pct_nonwhite", color_pal[4], "% Nonwhite", "Lowest")
pct_n_wh_dist <- grid.arrange(top_pct_n_wh,bot_pct_n_wh)
ggsave("./fig/pct_n_wh_dist.png")
top_hhi <- dense_plot_demos(ecplot, top_lists, "median_household_income", color_pal[5], "Median Household Income", "Highest")
bot_hhi <- dense_plot_demos(ecplot, bot_lists, "median_household_income", color_pal[5], "Median Household Income", "Lowest")
hhi_dist <- grid.arrange(top_hhi,bot_hhi)
ggsave("./fig/hhi_dist.png")
top_uer <- dense_plot_demos(ecplot, top_lists, "unemployment_rate", color_pal[6], "Unemployment", "Highest")
bot_uer <- dense_plot_demos(ecplot, bot_lists, "unemployment_rate", color_pal[6], "Unemployment", "Lowest")
uer_dist <- grid.arrange(top_uer,bot_uer)
ggsave("./fig/uer_dist.png")
top_ro <- dense_plot_demos(ecplot, top_lists, "pct_renter_occupied", color_pal[7], "% Renter Occupied", "Highest")
bot_ro <- dense_plot_demos(ecplot, bot_lists, "pct_renter_occupied", color_pal[7], "% Renter Occupied", "Lowest")
ro_dist <- grid.arrange(top_ro,bot_ro)
ggsave("./fig/ro_dist.png")
top_rur <- dense_plot_demos(ecplot, top_lists, "Percent_Rural", color_pal[8], "% Rural", "Highest")
bot_rur <- dense_plot_demos(ecplot, bot_lists, "Percent_Rural", color_pal[8], "% Rural", "Lowest")
rur_dist <- grid.arrange(top_rur,bot_rur)
ggsave("./fig/rur_dist.png")
top_gr <- dense_plot_demos(ecplot, top_lists, "median_gross_rent", color_pal[9], "Median Gross Rent", "Highest")
bot_gr <- dense_plot_demos(ecplot, bot_lists, "median_gross_rent", color_pal[9], "Median Gross Rent", "Lowest")
gr_dist <- grid.arrange(top_gr,bot_gr)
ggsave("./fig/gr_dist.png")
```
...
tplot_reg_pop <- grid.arrange(tplot_south_pop, tplot_northeast_pop, tplot_north_cent_pop, tplot_west_pop)
ggsave("./fig/tplot_reg_pop.png")
bplot_reg_pop <- grid.arrange(bplot_south_pop, bplot_northeast_pop, bplot_north_cent_pop, bplot_west_pop)
ggsave("./fig/bplot_reg_pop.png")
```
...
tplot_rur_pop <- grid.arrange(tplot_south_rural_pop, tplot_northeast_rural_pop, tplot_north_cent_rural_pop, tplot_west_rural_pop)
ggsave("./fig/tplot_rur_pop.png")
bplot_rur_pop <- grid.arrange(bplot_south_rural_pop, bplot_northeast_rural_pop, bplot_north_cent_rural_pop, bplot_west_rural_pop)
ggsave("./fig/bplot_rur_pop.png")
```
...
ptop_pov <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "poverty_rate", color_pal[1], "Poverty Rate", "Highest")
pbot_pov <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "poverty_rate", color_pal[1], "Poverty Rate", "Lowest")
pov_dist_pop <- grid.arrange(ptop_pov,pbot_pov)
ggsave("./fig/pov_dist_pop.png")
ptop_rb <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "rent_burden", color_pal[2], "Rent Burden", "Highest")
pbot_rb <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "rent_burden", color_pal[2], "Rent Burden", "Lowest")
rb_dist_pop <- grid.arrange(ptop_rb,pbot_rb)
ggsave("./fig/rb_dist_pop.png")
ptop_pct_wh <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "pct_white", color_pal[3], "% White", "Highest")
pbot_pct_wh <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "pct_white", color_pal[3], "% White", "Lowest")
pct_wh_dist_pop <- grid.arrange(ptop_pct_wh,pbot_pct_wh)
ggsave("./fig/pct_wh_dist_pop.png")
ptop_pct_n_wh <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "pct_nonwhite", color_pal[4], "% Nonwhite", "Highest")
pbot_pct_n_wh <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "pct_nonwhite", color_pal[4], "% Nonwhite", "Lowest")
pct_n_wh_dist_pop <- grid.arrange(ptop_pct_n_wh,pbot_pct_n_wh)
ggsave("./fig/pct_n_wh_dist_pop.png")
ptop_hhi <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "median_household_income", color_pal[5], "Median Household Income", "Highest")
pbot_hhi <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "median_household_income", color_pal[5], "Median Household Income", "Lowest")
hhi_dist_pop <- grid.arrange(ptop_hhi,pbot_hhi)
ggsave("./fig/hhi_dist_pop.png")
ptop_uer <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "unemployment_rate", color_pal[6], "Unemployment", "Highest")
pbot_uer <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "unemployment_rate", color_pal[6], "Unemployment", "Lowest")
uer_dist_pop <- grid.arrange(ptop_uer,pbot_uer)
ggsave("./fig/uer_dist_pop.png")
ptop_ro <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "pct_renter_occupied", color_pal[7], "% Renter Occupied", "Highest")
pbot_ro <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "pct_renter_occupied", color_pal[7], "% Renter Occupied", "Lowest")
ro_dist_pop <- grid.arrange(ptop_ro,pbot_ro)
ggsave("./fig/ro_dist_pop.png")
ptop_rur <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "Percent_Rural", color_pal[8], "% Rural", "Highest")
pbot_rur <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "Percent_Rural", color_pal[8], "% Rural", "Lowest")
rur_dist_pop <- grid.arrange(ptop_rur,pbot_rur)
ggsave("./fig/rur_dist_pop.png")
ptop_gr <- dense_plot_demos(ecplot_gte_mean, ptop_lists, "median_gross_rent", color_pal[9], "Median Gross Rent", "Highest")
pbot_gr <- dense_plot_demos(ecplot_gte_mean, pbot_lists, "median_gross_rent", color_pal[9], "Median Gross Rent", "Lowest")
gr_dist_pop <- grid.arrange(ptop_gr,pbot_gr)
ggsave("./fig/gr_dist_pop.png")
```
...
```{r cluster_eda}
# MAKE FUNCTION OUT OF THIS TOO
geo_clust <- subset(km, select = c("GEOID", "hw_km3", "hw_km4", "hw_km5", "hw_km6", "hw_km7", "ll_km3", "ll_km4", "ll_km5", "ll_km6", "ll_km7", "fg_km3", "fg_km4", "fg_km5", "fg_km6", "fg_km7", "mq_km3", "mq_km4", "mq_km5", "mq_km6", "mq_km7"))
