...
hw_km4 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Hartigan-Wong")
hw_km5 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Hartigan-Wong")
hw_km6 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Hartigan-Wong")
hw_km7 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Hartigan-Wong")
...
ll_km4 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Lloyd")
ll_km5 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Lloyd")
ll_km6 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Lloyd")
ll_km7 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Lloyd")
...
fg_km4 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Forgy")
fg_km5 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Forgy")
fg_km6 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Forgy")
fg_km7 <- kmeans(km_sc, 3, nstart = 25, algorithm = "Forgy")
...
mq_km4 <- kmeans(km_sc, 3, nstart = 25 , algorithm = "MacQueen")
mq_km5 <- kmeans(km_sc, 3, nstart = 25, algorithm = "MacQueen")
mq_km6 <- kmeans(km_sc, 3, nstart = 25, algorithm = "MacQueen")
mq_km7 <- kmeans(km_sc, 3, nstart = 25, algorithm = "MacQueen")
