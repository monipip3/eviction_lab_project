...
```{r allie knn}
# is our data missing completely at random or missing at random? 
# for determining similar counties, should probably use percent_rural, population, poverty-rate, rent-burden
knn <- subset(eviction_county, select = c(population, `poverty-rate`, `renter-occupied-households`, `pct-renter-occupied`, `median-gross-rent`, `median-household-income`, `median-property-value`, `rent-burden`, `pct-white`, `pct-af-am`, `pct-hispanic`, `pct-am-ind`, `pct-asian`, `pct-nh-pi`, `pct-multiple`, `pct-other`, `evictions`, `Percent_Rural`, `rural_flag`,`unemployment_rate`))
```