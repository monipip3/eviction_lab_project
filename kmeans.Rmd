...
# average_unemployment_rate is missing 0.08% while everything else is 0.01%
# plot_missing(km_avg)
...
# elbow 
set.seed(123)
fviz_nbclust(km_avg, kmeans, method = "wss")
# silhouette
fviz_nbclust(km_avg, kmeans, method = "silhouette")
# gap statistic 
# set.seed(123)
# gap_stat <- clusGap(km_avg, FUN = kmeans, nstart = 25, K.max = 100, B = 50)
# print(gap_stat, method = "firstmax")
# fviz_gap_stat(gap_stat)
...
# Compute k-means clustering with k = 4
set.seed(123)
final <- kmeans(km_avg, 4, nstart = 25)
print(final)
fviz_cluster(final, data = km_avg)
